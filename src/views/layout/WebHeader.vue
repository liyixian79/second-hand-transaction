<template>
	<div :class="['LayoutHeader-container',{'hiddenSvg':isLogin||!showSvg}]">
				...
				<div class="home-header">
					<div class="header-title">
						...
						<div class="header-nav">
							<ul class="nav-ul">
								<li class="li-item first" @click="toHome">首页</li>
					...
					<div class="header-search">
						<el-select v-model="searchValue" multiple filterable remote clearable reserve-keyword placeholder="请输入关键词" :remote-method="remoteMethod" :loading="loading" @change="handleSelect">
							<el-option v-for="item in searchList" :key="item._id" :label="item.title" :value="item._id">
							</el-option>
						</el-select>
					</div>
					<div class="header-user">
						<div class="user-news">
							<el-tooltip class="item" effect="dark" content="发帖" placement="bottom">
								<el-button size="small" type="primary" icon="el-icon-edit" circle @click="toAddNews('1')"></el-button>
							</el-tooltip>
						</div>
						...
						<el-dropdown v-else>
							<div class="user-img">
								...
								<template v-else>
									<img v-if="+user.sex===0" src="../../assets/home/头像 男孩.png">
									<img v-else src="../../assets/home/头像 女孩.png">
								</template>
							</div>
							<el-dropdown-menu slot="dropdown">
								...
								<el-dropdown-item style="color: #F56C6C" @click.native="loginOut">注销</el-dropdown-item>
							</el-dropdown-menu>
						</el-dropdown>
					</div>
				</div>
		...
		<div class="user-dialog">
			<el-dialog :visible.sync="showUserDialog" :close-on-click-modal="false" :show-close="false" :title="activeTab==='login'?'用户登录':'用户注册'" width=600px center>
				<el-tabs v-model="activeTab">
					<el-tab-pane label="登录" name="login" class="login">
						<el-form label-position="left" :model="loginForm" :rules="loginRules" ref="loginForm" style="margin-top: 20px">
							...
							<div class="tips">
								未注册账号？
								<span style="color: orangered;cursor: pointer" @click="activeTab='register'">立即注册</span>
							</div>
							<div class="form-btn">
					...
					<el-tab-pane label="注册" name="register">
						<el-form label-position="left" :model="registerForm" :rules="registerRules" ref="registerForm" style="margin-top: 20px" label-width="80px">
							<el-form-item prop="name" label="用户名">
								<el-input v-model="registerForm.name" placeholder="请输入用户名">
								</el-input>
							</el-form-item>
							<el-form-item prop="password" label="密码">
								<el-input type="password" v-model="registerForm.password" placeholder="请输入密码 不少于6位字符">
								</el-input>
							</el-form-item>
							...
							<el-form-item label="简介">
								<el-input type="textarea" v-model="registerForm.remark" placeholder="向大家介绍一下自己吧~">
								</el-input>
							</el-form-item>
							<div class="form-btn">
								<el-button @click="closeDialog" type="danger">取消</el-button>
